...
exports.default = (0, util_1.createRule)({
    ...
    meta: {
        type: 'suggestion',
        docs: {
            description: 'Disallow named re-exports of symbols that were imported in the same file. Default re-exports are allowed.',
            requiresTypeChecking: false,
        },
        messages: {
            noImportReexport: 'Avoid re-exporting imported symbols. Import them from their canonical module, where they are declared, to keep the dependency path direct.',
        },
        schema: [],
    },
    create(context) {
...
function isExceptionFile(filename) {
    ...
    return (/\/index\.(ts|tsx|js|jsx)$/.test(normalizedFilename) ||
