          ...
          <GridCol span={{ base: 12, md: 6 }}>
            <Stack gap="lg">
              ...
              <Text size="lg" c="dimmed">
                ...
                Upload a PDF, review AI suggestions, and download a permanently
                redacted file.
              </Text>
              <Group>
    ...
    <Container size={pageContainerSize} py="xl">
      <Stack gap="lg">
        ...
        <Text ta="center" c="dimmed">
          AI finds names, addresses, emails, SSNs, and more — you review before
          download.
        </Text>
      </Stack>
    </Container>
...
function BeforeAfterPlaceholder(props: { title: string }): React.ReactElement {
  const { title } = props;
      ...
      <Container size={pageContainerSize}>
        <Stack gap="lg">
          ...
          <Text ta="center" c="dimmed" size="sm">
            Files are processed with a cloud vision model in the United States,
            then deleted within one hour.
          </Text>
        </Stack>
      </Container>
    </Box>
...
function PricingCell(props: { value: string }): React.ReactElement {
  const { value } = props;
...
function LandingPageWhyFree(): React.ReactElement {
  return (
    <Box
      bg="gray.0"
      py="xl"
